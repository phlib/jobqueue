...
class DbSchedulerTest extends TestCase
{
    ...
    public function testQueryJobsWithRetrySuccessAfterDeadlock(): void
    {
        ...
        $deadlockException = new \PDOException('Deadlock found when trying to get lock');
        $deadlockException->errorInfo = ['40001', 1213, 'Deadlock found when trying to get lock'];
